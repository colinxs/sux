/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=sux/wrangler.jsonc` (hash: 4a15d28e4901cd4b44cbe3b084fedb98)
...
interface __BaseEnv_Env {
	...
	DEBUG_MCP: "0";
	MAIL_TRIAGE_ENABLED: "1";
	WEEKLY_RECALL_ENABLED: "1";
	SELF_IMPROVE_ENABLE: "1";
	LIFE_WIKI_ENABLED: "0";
	...
	OP_WORKFLOW: Workflow<Parameters<import("./sux/src/index").OpWorkflow['run']>[0]['payload']>;
	MCP_RATE_LIMITER: RateLimit;
	OBS_RATE_LIMITER: RateLimit;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./sux/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEBUG_MCP" | "MAIL_TRIAGE_ENABLED" | "WEEKLY_RECALL_ENABLED" | "SELF_IMPROVE_ENABLE" | "LIFE_WIKI_ENABLED" | "TS_OAUTH_CLIENT_ID" | "TS_OAUTH_CLIENT_SECRET" | "TAILSCALE_OAUTH_CLIENT_ID" | "TAILSCALE_OAUTH_CLIENT_SECRET" | "TAILSCALE_TAILNET" | "DROPBOX_FULL_APP_KEY" | "DROPBOX_FULL_REFRESH_TOKEN">> {}
}
