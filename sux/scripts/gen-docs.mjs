...
const CATEGORIES = [
	...
	["Research / reference", ["consensus", "arxiv", "pubmed", "openalex", "crossref", "semantic_scholar", "clinical_trials", "stackexchange", "reddit", "coingecko", "youtube"]],
	["People / places / social", ["people", "people_finder", "places", "linkedin", "facebook", "uw"]],
	["Notes / knowledge / vault", ["obsidian", "ingest", "citation", "consolidate", "vault_consolidate_plan", "vault_cross_link_plan", "graph_health"]],
