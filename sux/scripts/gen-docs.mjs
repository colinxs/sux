...
const CATEGORIES = [
	...
	["Notes / knowledge / vault", ["obsidian", "ingest", "citation", "consolidate", "vault_consolidate_plan"]],
	["Knowledge / learning", ["recall", "oracle", "study", "advise", "learn", "preferences", "life_wiki", "onboard", "agenda"]],
