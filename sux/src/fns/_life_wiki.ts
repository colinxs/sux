...
// The stores each facet fans out over. mail/files/calendar/contacts/imessage degrade quietly
// when unconfigured (recall reports them as "no matches"/"unavailable"), so this list is safe
...
// calendar/contacts/imessage to be answerable at all.
const WIKI_SOURCES = ["vault", "files", "mail", "calendar", "contacts", "imessage", "learned"];
