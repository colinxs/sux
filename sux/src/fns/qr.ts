...
export const qr: Fn = {
	name: "qr",
	description: "Encode text into a QR code PNG (base64) or decode a QR image back to text. direction: encode (default; give `data`) | decode (give `image` as a url or base64). size is the PNG edge in px for encode.",
	inputSchema: {
		type: "object",
