...
export const CRON_JOBS = ["kroger_token", "mychart_token", "mail_triage", "ask_gate_reminder", "weekly_recall", "consolidate", "briefing", "agenda", "adblock", "life_wiki", "self_improve", "web_search_selftest"] as const;
