...
export const CRON_JOBS = ["kroger_token", "mychart_token", "mail_triage", "mail_triage_plan", "ask_gate_reminder", "weekly_recall", "consolidate", "briefing", "agenda", "adblock", "life_wiki", "self_improve", "web_search_selftest", "learning_folder"] as const;
