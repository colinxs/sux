...
export const CRON_JOBS = ["kroger_token", "mychart_token", "mail_triage", "mail_triage_plan", "ask_gate_reminder", "agenda_reply", "imessage_reply", "weekly_recall", "consolidate", "watch_sweep", "cross_semantic", "briefing", "agenda", "adblock", "life_wiki", "infer_nudge", "self_improve", "web_search_selftest", "learning_folder"] as const;
